...
INSERT INTO flats (building_id, flat_num, floor_num, resident_id) VALUES
  ('b1000000-0000-0000-0000-000000000001', 'A-301', 3, 'u3000000-0000-0000-0000-000000000004'),
  ('b1000000-0000-0000-0000-000000000001', 'A-502', 5, 'u3000000-0000-0000-0000-000000000005'),
  ('b2000000-0000-0000-0000-000000000002', 'B-201', 2, 'u3000000-0000-0000-0000-000000000006')
...
INSERT INTO visitors (name, phone, purpose, target_flat, target_resident_id, trust_score, trust_level, face_match, status, logged_by, viewed_by_resident) VALUES
  ('Amit Joshi', '+91-9300000001', 'Delivery', 'A-301',
   'u3000000-0000-0000-0000-000000000004', 82, 'Low', 92, 'approved',
   'u2000000-0000-0000-0000-000000000002', true),
  ('Ravi Desai', '+91-9300000002', 'Plumber visit', 'A-502',
   'u3000000-0000-0000-0000-000000000005', 55, 'Medium', 88, 'pending',
   'u2000000-0000-0000-0000-000000000002', false),
  ('Unknown Person', NULL, 'Unknown', 'B-201',
   'u3000000-0000-0000-0000-000000000006', 25, 'High', 61, 'denied',
   'u2000000-0000-0000-0000-000000000003', false)
